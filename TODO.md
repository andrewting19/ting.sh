...
- [x] Ghostty fork parity fixes — published `@andrewting19/ghostty-web@0.5.4` with real line-height support, OSC 52 clipboard writes, `macOptionIsMeta`, WASM page zero-init, stable scrollback/page rendering, wheel-coordinate forwarding for mouse-tracked TUIs, and FitAddon width calculations that no longer leave a fake right-edge gap
