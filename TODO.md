...
- [ ] Ghostty snapshot reconnect parity — visible content, semantic scrollback, and saved viewport position are restored, but exact normal-buffer baseY semantics still diverge from xterm around rendered-text restore and mixed normal/alternate-screen flows
