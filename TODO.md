...
- [ ] Ghostty snapshot reconnect parity — visible content and semantic scrollback are restored, but normal-buffer baseY/viewport-offset semantics still diverge from xterm around rendered-text restore and mixed normal/alternate-screen flows
