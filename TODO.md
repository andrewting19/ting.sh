...
- [x] Ghostty fork parity fixes — published `@andrewting19/ghostty-web@0.5.3` with real line-height support, OSC 52 clipboard writes, `macOptionIsMeta`, WASM page zero-init, stable scrollback/page rendering, and wheel-coordinate forwarding for mouse-tracked TUIs
