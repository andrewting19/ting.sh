...
- One-shot live study workflow — `bun run scripts/study-live-sessions.ts [renderer] [output-dir]` now captures, measures, and summarizes every live session into a single report JSON
